...
**Frontend:** React · Next.js · TypeScript · TailwindCSS · Three.js · React Flow
 
**Cloud / Infra:** AWS (ECS Fargate, ECR, Lambda, S3, DynamoDB) · GCP (Cloud Run) · Azure (AKS) · Kubernetes · GitHub Actions · CI/CD · Git
